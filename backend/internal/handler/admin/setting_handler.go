...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		OpenAICyberAccountCooldownEnabled:                      settings.OpenAICyberAccountCooldownEnabled,
		OpenAICyberAccountCooldownWindowSeconds:                settings.OpenAICyberAccountCooldownWindowSeconds,
		OpenAICyberAccountCooldownFirstSeconds:                 settings.OpenAICyberAccountCooldownFirstSeconds,
		OpenAICyberAccountCooldownEscalatedSeconds:             settings.OpenAICyberAccountCooldownEscalatedSeconds,
		OpenAICyberAccountCooldownGroupIDs:                     settings.OpenAICyberAccountCooldownGroupIDs,
		...
		OpenAIWindowWarmupEnabled:                              settings.OpenAIWindowWarmupEnabled,
		OpenAIWindowWarmupDefaultPolicy:                        settings.OpenAIWindowWarmupDefaultPolicy,
		OpenAIWindowWarmupAllowlist:                            settings.OpenAIWindowWarmupAllowlist,
		OpenAIWindowWarmupProbeModel:                           settings.OpenAIWindowWarmupProbeModel,
		OpenAIWindowWarmupWorkerConcurrency:                    settings.OpenAIWindowWarmupWorkerConcurrency,
		OpenAIWindowWarmupGlobalQPS:                            settings.OpenAIWindowWarmupGlobalQPS,
		OpenAIWindowWarmupBatchSize:                            settings.OpenAIWindowWarmupBatchSize,
		OpenAIWindowWarmupScanSeconds:                          settings.OpenAIWindowWarmupScanSeconds,
		OpenAIWindowWarmupRequestTimeoutSeconds:                settings.OpenAIWindowWarmupRequestTimeoutSeconds,
		OpenAIWindowWarmupLeaseSeconds:                         settings.OpenAIWindowWarmupLeaseSeconds,
		OpenAIWindowWarmupResetGraceSeconds:                    settings.OpenAIWindowWarmupResetGraceSeconds,
