...
func (r *codexTicketFailSaveRepo) CompareAndSwapCodexTicket(context.Context, *Account, map[string]CodexTicketExtraValue, map[string]CodexTicketExtraValue, *CodexTicketLease) (bool, error) {
	return false, errors.New("simulated database unavailable")
}
