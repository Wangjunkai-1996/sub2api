...
const (
	...
	// NewAPIUserID is a positive end-user ID from a verified NewAPI signature.
	// It never replaces UserID for Sub2API billing or authorization.
	NewAPIUserID Key = "ctx_newapi_user_id"
