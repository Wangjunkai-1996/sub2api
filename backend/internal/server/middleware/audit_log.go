...
var auditActionOverrides = map[string]string{
	...
	"POST /api/v1/admin/egress-routes/verify":                 "admin.egress_routes.verify",
	"POST /api/v1/admin/egress-routes/:id/confirm-identity":   "admin.egress_routes.confirm_identity",
}
