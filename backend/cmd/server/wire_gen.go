...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	redisStrictAuditLineageStore := securityaudit.NewRedisStrictAuditLineageStore(redisClient, configConfig)
	coordinator := securityaudit.ProvideCoordinator(legacyEngine, promptService, redisStrictAuditLineageStore)
