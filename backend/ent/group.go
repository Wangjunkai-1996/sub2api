...
type Group struct {
	...
	// 分组调度模式：inherit 沿用全局开关，basic 强制旧调度，advanced 强制高级调度
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case group.FieldVideoModelPrices, group.FieldModelPricing, group.FieldModelRouting, group.FieldSupportedModelScopes, group.FieldMessagesDispatchModelConfig, group.FieldModelsListConfig, group.FieldCodexModelsManifestConfig, group.FieldReasoningEffortMappings, group.FieldAdvancedSchedulerOverrides:
			values[i] = new([]byte)
