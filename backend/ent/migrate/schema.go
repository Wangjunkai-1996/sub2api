...
var (
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "scheduler_type", Type: field.TypeString, Size: 16, Default: "inherit"},
		{Name: "advanced_scheduler_overrides", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "traffic_director_mode", Type: field.TypeString, Size: 16, Default: "legacy"},
		{Name: "traffic_director_version", Type: field.TypeInt64, Default: 0},
		{Name: "traffic_director_spec", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
	}
