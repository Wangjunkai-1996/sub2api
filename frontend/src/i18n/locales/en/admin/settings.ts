    ...
    settings: {
      ...
      features: {
        ...
        riskControl: {
          ...
          cyberSessionBlockScope: 'Local block scope',
          cyberSessionBlockScopeHint: 'This scope only controls local session blocking after a cyber_policy hit. True Cyber events remain in audit records whether or not local blocking applies.',
          cyberSessionBlockAllGroups: 'All groups',
          cyberSessionBlockSpecificGroups: 'Specific groups',
          cyberSessionBlockSearchGroups: 'Search group name, platform, or type',
