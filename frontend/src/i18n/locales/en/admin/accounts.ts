export default {
    accounts: {
      ...
      openai: {
        ...
        codexTurnTicketDesc: 'Ticket mode and status for the configured models. Requests are paused without a valid ticket only when fail-closed is enabled.',
        codexTurnTicketMissing: 'No valid {length} ticket; requests remain allowed',
        codexTurnTicketMissingGeneric: 'No valid ticket; requests remain allowed',
        codexTurnTicketReady: '{time} left',
        codexTurnTicketPaused: 'No {length} ticket; this model is paused',
        codexTurnTicketPausedGeneric: 'Ticket not ready; this model is paused',
