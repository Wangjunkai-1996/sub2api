export default {
  ...
  "planPro": "Pro (292)",
  "planTeam": "Team (332)",
  "planHint": "Select the plan manually. Tickets must match the selected length and pass actual model and business egress verification. Changing plans requires a new ticket.",
  ...
  "globalPoolHint": "This switch controls tickets for this account. Harvesting uses the global pool; normal requests keep this account's configured business egress.",
  "proxy": "Harvest proxy",
  ...
  "proxyHint": "Used only to acquire STATE. Normal requests keep this account’s saved business egress. Tickets are verified before use, valid for about one hour and refreshed before expiry.",
  ...
  "modelHint": "Only this model uses tickets and pauses when no valid ticket is available. Other models keep normal forwarding. Changing the model requires a new ticket.",
  ...
  "fixedProxyUnsaved": "The business egress above has unsaved changes. Save the account and reopen this dialog first.",
  "businessEgressMissing": "No verifiable business egress is configured. Save the account’s proxy or egress pool first.",
  ...
  "states": {
    ...
    "error": "Acquisition failed"
      ...
      columns: {
        ...
        status: 'Status',
        openaiWindowWarmup: 'Codex Warmup',
        schedulable: 'Schedulable',
      ...
      bulkEdit: {
        ...
        egressMixedFields: 'Static IP egress and other account fields must be saved separately. Update the egress pool first, then edit the remaining fields.',
        egressSavedOtherFieldsFailed: 'Static IP egress was updated, but the other account settings were not all saved: {reason}. Refresh and retry the other settings.',
        egressSavedConfirmOtherFields: 'Static IP egress has already been updated. The other account settings are not saved yet: {message}',
        egressSavedOtherFieldsCancelled: 'Static IP egress was updated, but saving the other account settings was cancelled. The account list has been refreshed.',
      ...
      openai: {
        ...
        codexTurnTicketMissing: 'Waiting for {length} STATE',
        codexTurnTicketReady: '{time} left',
        codexTurnTicketPaused: 'Waiting for {length} STATE; target model paused',
        codexTurnTicketMissingGeneric: 'Waiting for STATE',
        codexTurnTicketPausedGeneric: 'Waiting for STATE; target model paused',
        codexWarmupPolicy: 'Five-hour window warmup',
        codexWarmupPolicyDesc: 'Send a minimal Codex request after import and, for continuous policy, after authoritative upstream resets.',
        codexWarmupPolicyOff: 'Off',
        codexWarmupPolicyInitialOnce: 'Once',
        codexWarmupPolicyContinuous: 'Continuous',
        windowWarmup: {
          requeue: 'Requeue warmup',
          unblock: 'Unblock and retry',
          requeueSuccess: 'Warmup job requeued',
          unblockSuccess: 'Warmup job unblocked',
          actionFailed: 'Warmup action failed',
          nextRun: 'Next run',
          lastSuccess: 'Last success',
          observedReset: 'Upstream reset',
          states: {
            off: 'Off',
            pending: 'Pending',
            armed: 'Armed',
      ...
      egressPool: {
        title: 'Static egress pool',
        description: 'Assign one or more fixed egress IPs to this account. Only selected routes are used; there is no automatic direct fallback.',
        direct: 'This server (direct)',
        proxy: 'Proxy route',
        unnamedProxy: 'Proxy route #{id}',
        primary: 'Primary auth egress',
        primaryHint: 'OAuth authorization and initial authentication use this route consistently.',
        selectPrimary: 'Use for authentication',
        inherited: 'Inherited parent egress pool',
        inheritedHint: 'Spark shadow accounts inherit their routes and per-egress concurrency from the parent and cannot override them.',
        empty: 'No assignable egress routes',
        catalogUnavailable: 'Egress route catalog is unavailable',
        routeCount: '{count} egress routes',
        noSelection: 'Select at least one egress. This server is never used implicitly.',
        primaryRequired: 'Select an authentication egress from the assigned routes.',
        perEgressConcurrency: 'Concurrency per egress',
        perEgressConcurrencyHint: 'Applied uniformly to every selected egress. Effective capacity is calculated by the server from eligible distinct IPs.',
        capacityFormula: '{eligible} eligible IPs x {perEgress} = {capacity}',
        capacityDetail: '{configured} configured, {eligible} eligible, {degraded} degraded',
        degraded: 'Partially degraded',
        verify: 'Verify egress',
        verifyFailed: 'Egress verification failed',
        reason: {
          route_not_found: 'The egress route does not exist',
          route_unavailable: 'This egress cannot currently be verified',
          probe_failed: 'Network probe failed; check the proxy connection',
          invalid_observation: 'No valid public IP was returned',
          revision_conflict: 'The egress configuration changed; reload and try again',
          ...
          route_retired: 'The egress has been retired',
          identity_unavailable: 'The public IP identity is unavailable',
          direct_route_unavailable: 'This server direct egress is unavailable',
          proxy_unavailable: 'The proxy route is unavailable',
          proxy_inactive: 'The proxy route is inactive',
          proxy_expired: 'The proxy route has expired',
          route_kind_invalid: 'The egress route type is invalid',
          unknown: 'Egress verification failed ({code})'
        },
        state: {
          ...
          inactive: 'Inactive',
          expired: 'Expired',
          identity_mismatch: 'IP identity changed',
          retired: 'Retired'
        },
        bulk: {
          ...
          append: 'Append',
          remove: 'Remove',
          replaceHint: 'Replace each account\'s entire egress pool with the selected routes.',
          appendHint: 'Append the selected routes to each account\'s existing pool.',
          removeHint: 'Remove the selected routes from each account\'s existing pool.'
        }
      },
