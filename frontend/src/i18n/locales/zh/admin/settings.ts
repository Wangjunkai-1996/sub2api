    ...
    settings: {
      ...
      features: {
        ...
        riskControl: {
          ...
          cyberSessionBlockScope: '本地屏蔽范围',
          cyberSessionBlockScopeHint: '此范围只控制 cyber_policy 命中后的本地会话屏蔽。无论是否屏蔽，真实 Cyber 事件仍会保留审计记录。',
          cyberSessionBlockAllGroups: '全部分组',
          cyberSessionBlockSpecificGroups: '指定分组',
          cyberSessionBlockSearchGroups: '搜索分组名称、平台或类型',
